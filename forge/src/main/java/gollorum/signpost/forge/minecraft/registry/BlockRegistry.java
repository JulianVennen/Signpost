...
import static gollorum.signpost.forge.Signpost.MOD_ID;
...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> WaystoneBlock =
        Register.register(gollorum.signpost.forge.minecraft.block.WaystoneBlock.REGISTRY_NAME,
            gollorum.signpost.forge.minecraft.block.WaystoneBlock::createInstance);
