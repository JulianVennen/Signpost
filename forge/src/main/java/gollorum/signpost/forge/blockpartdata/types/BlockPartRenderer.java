...
import gollorum.signpost.forge.blockpartdata.types.renderers.*;
...
public abstract class BlockPartRenderer<T extends BlockPart<T>> {
    ...
    static {
        register(gollorum.signpost.forge.blockpartdata.types.PostBlockPart.class, new PostRenderer());
        register(gollorum.signpost.forge.blockpartdata.types.SmallWideSignBlockPart.class, new WideSignRenderer());
        register(gollorum.signpost.forge.blockpartdata.types.SmallShortSignBlockPart.class, new ShortSignRenderer());
        register(gollorum.signpost.forge.blockpartdata.types.LargeSignBlockPart.class, new LargeSignRenderer());
        register(gollorum.signpost.forge.blockpartdata.types.WaystoneBlockPart.class, new WaystoneRenderer());
    }
